...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 28 11:30:40 2020
...
#保存结果并输出
# pd.DataFrame(pd.concat(t[1:])).to_sv('result.txt', header = False)
df = pd.DataFrame(pd.concat(t[1:])).reset_index().rename(columns={"index":"word", 0:"freq"})
